...
const RiderRegisterScreen: React.FunctionComponent = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
    ...
    >
      <KeyboardAvoidingView style={styles.container} enabled behavior='padding'>
        <View style={styles.loginContainer}>
          ...
          />
          {errors.fullName && (
            <Text style={{ color: 'red' }}>*Driving License is required.</Text>
          )}
          ...
          />
          {errors.fullName && (
            <Text style={{ color: 'red' }}>*Present address is required.</Text>
          )}
          ...
          />
          {errors.fullName && (
            <Text style={{ color: 'red' }}>*Parmanent address is required.</Text>
          )}
          ...
          />
          {errors.fullName && (
            <Text style={{ color: 'red' }}>Side notes.</Text>
          )}
